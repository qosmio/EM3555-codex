...
void emberAfFillCommandGroupsClusterAddGroupResponse(EmberAfStatus status,
                                                     uint16_t groupId);
void emberAfFillCommandGroupsClusterViewGroupResponse(EmberAfStatus status,
                                                      uint16_t groupId,
                                                      uint8_t *groupName);
void emberAfFillCommandGroupsClusterGetGroupMembershipResponse(uint8_t capacity,
                                                               uint8_t groupCount,
                                                               uint8_t *groupList,
                                                               uint16_t groupListLen);
void emberAfFillCommandGroupsClusterRemoveGroupResponse(EmberAfStatus status,
                                                        uint16_t groupId);
