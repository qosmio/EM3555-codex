...
void emberAfFillCommandScenesClusterRemoveSceneResponse(EmberAfStatus status,
                                                        uint16_t groupId,
                                                        uint8_t sceneId);
void emberAfFillCommandScenesClusterRemoveAllScenesResponse(EmberAfStatus status,
                                                            uint16_t groupId);
void emberAfFillCommandScenesClusterStoreSceneResponse(EmberAfStatus status,
                                                       uint16_t groupId,
                                                       uint8_t sceneId);
